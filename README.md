...
```lua
   art
    ...
    ├── art-framework -- 通用工具封装
       ...
       ├── art-spring-boot-starter-xxl-job  -- xss过滤
...
## 🍺加入我们
| 交流群                  | ![](https://cdn.staticaly.com/gh/fxzbiz/img@url/2022/11/19/dqDn4c.png) | ![](https://cdn.staticaly.com/gh/fxzbiz/img@url/2022/12/04/n62gVS.png) |
| ----------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
