...
@Getter
@Slf4j
public abstract class AbstractRedisGroupMessageListener<T extends RedisGroupMessage>
	...
	@SneakyThrows
	protected AbstractRedisGroupMessageListener() {
		this.messageType = getMessageClass();
		this.streamKey = messageType.newInstance().getGroup();
	}
