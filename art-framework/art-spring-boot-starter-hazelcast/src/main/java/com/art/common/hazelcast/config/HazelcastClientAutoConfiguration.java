...
// System.out.println("服务实例:" + serverInstances.getIfAvailable());
// HazelcastClientFactory hazelcastClientFactory = new HazelcastClientFactory(properties);
// System.out.println("客户端实例:" + hazelcastClientFactory);
