...
//
/// **
// * HazelcastBaseAutoConfiguration
// *
// * @author fxz
// * @version 0.0.1
...
//
// @Bean
// DistributedLockFactory distributedLockFactory(@Qualifier("hazelcastInstance")
// HazelcastInstance hazelcastInstance) {
// return new HazelcastLockFactory(hazelcastInstance);
// }
//
// @Bean
// DistributedMapFactory distributedMapFactory(@Qualifier("hazelcastInstance")
// HazelcastInstance hazelcastInstance) {
...
//
// @Bean
// DistributedSetFactory distributedSetFactory(@Qualifier("hazelcastInstance")
// HazelcastInstance hazelcastInstance) {
