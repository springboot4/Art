...
import com.fxz.gateway.fallback.FxzGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class FxzGatewaySentinelFilter {
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new FxzGatewayBlockFallbackProvider());
        initGatewayRules();
    }
