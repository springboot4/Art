...
public class FxzGatewayErrorConfigure {
	...
	public FxzGatewayErrorConfigure(ServerProperties serverProperties, ResourceProperties resourceProperties,
	...
	public ErrorWebExceptionHandler errorWebExceptionHandler(ErrorAttributes errorAttributes) {
		FxzGatewayExceptionHandler exceptionHandler = new FxzGatewayExceptionHandler(errorAttributes,
