 ...
 */
@Mapper
public interface UserPostConvert {

	UserPostConvert INSTANCE = Mappers.getMapper(UserPostConvert.class);

	List<UserPostDTO> convert(List<UserPostDO> list);

	Page<UserPostDTO> convert(Page<UserPostDO> list);

	UserPostDTO convert(UserPostDO userPost);

	UserPostDO convert(UserPostDTO userPost);
