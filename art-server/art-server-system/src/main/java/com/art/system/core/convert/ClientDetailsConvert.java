...
public interface ClientDetailsConvert {
	...
	Page<ClientDetailsDTO> convertPage(Page<ClientDO> sysOauthClientDetailsDO);

	List<ClientDetailsDTO> convertList(List<ClientDO> sysOauthClientDO);

	ClientDetailsDTO convert(ClientDO sysOauthClientDO);

	ClientDO convert(ClientDetailsDTO sysOauthClientDetailsDTO);
