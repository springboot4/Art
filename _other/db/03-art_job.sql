...
-- ----------------------------
BEGIN;
INSERT INTO `qrtz_scheduler_state` (`sched_name`, `instance_name`, `last_checkin_time`, `checkin_interval`) VALUES ('schedulerName', 'fxzdeMacBook-Pro.local1680782977169', 1680783388551, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `qrtz_triggers` (`sched_name`, `trigger_name`, `trigger_group`, `job_name`, `job_group`, `description`, `next_fire_time`, `prev_fire_time`, `priority`, `trigger_state`, `trigger_type`, `start_time`, `end_time`, `calendar_name`, `misfire_instr`, `job_data`) VALUES ('schedulerName', 'TASK_CLASS_NAME114', 'demoJob', 'TASK_CLASS_NAME114', 'demoJob', NULL, 1680783346000, 1680783345000, 5, 'PAUSED', 'CRON', 1680783335000, 0, NULL, -1, '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_job` (`job_id`, `job_name`, `job_group`, `parameters`, `cron_expression`, `misfire_policy`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (114, 'demoJob', 'demoJob', '111111', '* * * * * ?', '1', '1', 'fxz', '2022-12-07 12:28:06', 'fxz', '2023-04-06 20:15:45', '');
COMMIT;
