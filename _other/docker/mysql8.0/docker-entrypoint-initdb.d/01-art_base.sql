...
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `name`, `perms`, `type`, `component`, `path`, `redirect`, `icon`, `keep_alive`, `order_num`, `create_time`, `update_time`, `create_by`, `update_by`, `hidden`, `application`) VALUES (1977294312028540929, 0, 'ai知识库qa', 'AiQaPairsList', 'ai:dataset:qa', '0', 'ai/qa/AiQaPairsList.vue', '/ai/dataset/qa', '', '', 1, 10, '2025-10-12 16:44:35', '2025-10-12 18:25:27', 'fxz', 'fxz', '1', 1);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `name`, `perms`, `type`, `component`, `path`, `redirect`, `icon`, `keep_alive`, `order_num`, `create_time`, `update_time`, `create_by`, `update_by`, `hidden`, `application`) VALUES (1984864836579786754, 0, 'ai agent', 'AgentStudio', 'ai:agent', '0', 'ai/agent/AgentStudio.vue', '/ai/agent', '', '', 1, 1, '2025-11-02 14:07:09', '2025-11-02 14:07:09', 'fxz', 'fxz', '1', 1);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `name`, `perms`, `type`, `component`, `path`, `redirect`, `icon`, `keep_alive`, `order_num`, `create_time`, `update_time`, `create_by`, `update_by`, `hidden`, `application`) VALUES (1984900707538468865, 1984864836579786754, '查看agent', 'ai:agent:view', 'ai:agent:view', '1', '', '', '', '', 1, 99, '2025-11-02 16:29:41', '2025-11-02 16:29:41', 'fxz', 'fxz', '', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `name`, `perms`, `type`, `component`, `path`, `redirect`, `icon`, `keep_alive`, `order_num`, `create_time`, `update_time`, `create_by`, `update_by`, `hidden`, `application`) VALUES (1984900775419084802, 1984864836579786754, '删除agent', 'ai:agent:delete', 'ai:agent:delete', '1', '', '', '', '', 1, 99, '2025-11-02 16:29:57', '2025-11-02 16:29:57', 'fxz', 'fxz', '', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `name`, `perms`, `type`, `component`, `path`, `redirect`, `icon`, `keep_alive`, `order_num`, `create_time`, `update_time`, `create_by`, `update_by`, `hidden`, `application`) VALUES (1984900850274828289, 1984864836579786754, '更新agent', 'ai:agent:update', 'ai:agent:update', '1', '', '', '', '', 1, 99, '2025-11-02 16:30:15', '2025-11-02 16:30:15', 'fxz', 'fxz', '', NULL);
INSERT INTO `sys_menu` (`id`, `parent_id`, `title`, `name`, `perms`, `type`, `component`, `path`, `redirect`, `icon`, `keep_alive`, `order_num`, `create_time`, `update_time`, `create_by`, `update_by`, `hidden`, `application`) VALUES (1984900922622377986, 1984864836579786754, '添加agent', 'ai:agent:add', 'ai:agent:add', '1', '', '', '', '', 1, 99, '2025-11-02 16:30:32', '2025-11-02 16:30:32', 'fxz', 'fxz', '', NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (13, 12);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (13, 6);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (13, 7);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (13, 4);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (13, 5);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 2);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 3);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 4);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 5);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 6);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 7);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 12);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 20);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 21);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 29);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100006);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100009);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100010);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100011);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100008);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100007);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100012);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100013);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100014);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100015);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100016);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100017);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100018);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100019);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100020);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100021);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100022);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100023);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100024);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100025);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100026);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100027);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100028);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100029);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100030);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100031);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100032);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100033);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100034);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100035);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100036);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100037);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100038);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100039);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100040);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100041);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100042);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100043);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100044);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100045);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100046);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100047);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100048);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100049);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 100050);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1628281206988611586);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1628282988909305858);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1628283417441345538);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1628317343117275137);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1628317471911768065);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1628317584814043138);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1628317214134038530);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1628656999216459777);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1628728529633726466);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1628966690909663233);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1646327120896270338);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1646327719289233410);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1646327832816459777);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1646328655927648257);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1646328545541955585);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 10);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1643914857870577666);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1643914131685560321);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1643915123281940482);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1643915724992598018);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1643915864348348417);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1643916004987555842);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1643916153356865538);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1643916725887750145);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1643918418641735681);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1643917900674551810);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1947373944789016578);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1950611694533042178);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1950611817623281665);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1950611896321007617);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1950611982950162434);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1948746158314680322);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1948746277923647489);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1948743715304505345);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1948746387512422401);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 19487464798080);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1973309578902540289);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1973310066154835969);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1973310172430110721);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1973310259596136450);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1973310337702465538);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1973413747810484226);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1973415590561169410);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1973441926402977793);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1973645406585491457);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1973683226884759554);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1976278299929530369);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1976279035769835522);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1976279483100745730);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1976280323416969218);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1976280426068365313);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1976280499078615042);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1976280566099398658);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1976280682906570754);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1976281003280093186);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1976286148311175170);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1977294312028540929);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1984864836579786754);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1984900707538468865);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1984900775419084802);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1984900850274828289);
INSERT INTO `art_base`.`sys_role_menu` (`ROLE_ID`, `MENU_ID`) VALUES (1, 1984900922622377986);
COMMIT;
