...
<!--        <image class="logo" src="../../static/logo.png" />-->
    ...
    <view class="yt-list">
      <view class="yt-list-cell b-b">
        ...
        <text class="cell-tip">￥{{ totalAmount / 100 }}</text>
      </view>
      <view class="yt-list-cell b-b">
        <text class="cell-tit clamp">优惠金额</text>
        <text class="cell-tip red">-￥{{ couponAmount / 100 }}</text>
      </view>
      <view class="yt-list-cell b-b">
        <text class="cell-tit clamp">运费</text>
        <text class="cell-tip" v-if="freightAmount == 0">免运费</text>
        <text class="cell-tip" v-else>-￥{{ freightAmount / 100 }}</text>
      </view>
...
<script>
import {confirm, submit} from '../../api/order/order.js';
