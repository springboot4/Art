    ...
    <div class="m-3 p-3 bg-white">
      ...
      <vxe-form>
        <vxe-form-item title="角色名称">
          <vxe-input placeholder="请输入" v-model="model.queryParam.roleName" />
        </vxe-form-item>
        <vxe-form-item>
          <a-space>
      ...
      >
        ...
        <vxe-column field="remark" title="角色描述" />
...
<script lang="ts" setup>
   ...
   */
  function add() {
    roleEdit.value?.init(null, FormOperationType.ADD)
  }
   ...
   */
  function show(item) {
    roleEdit.value?.init(item.roleId, FormOperationType.SHOW)
  }
   ...
   */
  function edit(item) {
    roleEdit.value?.init(item.roleId, FormOperationType.EDIT)
  }
