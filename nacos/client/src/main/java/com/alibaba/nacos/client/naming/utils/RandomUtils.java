...
/**
 * <p>
 * <code>RandomUtils</code> is a wrapper that supports all possible
 * {@link java.util.Random} methods via the {@link java.lang.Math#random()} method and its
 * system-wide <code>Random</code> object.
 *
...
public class RandomUtils {
	 ...
	 * <p>
	 * Returns a pseudorandom, uniformly distributed int value between <code>0</code>
	 * (inclusive) and the specified value (exclusive), from the given Random sequence.
	 * </p>
	 * @param random the Random sequence generator.
	 * @param n the specified exclusive max-value
	 * @return the random int
	...
	/**
	 * <p>
	 * Returns the next pseudorandom, uniformly distributed long value from the given
	 * Random sequence.
	 * </p>
	 * @param random the Random sequence generator.
	 * @return the random long
	...
	/**
	 * <p>
	 * Returns the next pseudorandom, uniformly distributed boolean value from the given
	 * random sequence.
	 * </p>
	 * @param random the Random sequence generator.
	 * @return the random boolean
	 ...
	 * <p>
	 * Returns the next pseudorandom, uniformly distributed float value between
	 * <code>0.0</code> and <code>1.0</code> from the given Random sequence.
	 * </p>
	 * @param random the Random sequence generator.
	 * @return the random float
	 */
