...
public class CacheData {
	...
	/**
	 * Add listener if CacheData already set new content, Listener should init lastCallMd5
	 * by CacheData.md5
	...
	private void safeNotifyListener(final String dataId, final String group, final String content, final String md5,
			...
			public void run() {
				...
				try {
					...
					LOGGER.error("[{}] [notify-error] dataId={}, group={}, md5={}, listener={} errCode={} errMsg={}",
							name, dataId, group, md5, listener, de.getErrCode(), de.getErrMsg());
				}
				catch (Throwable t) {
