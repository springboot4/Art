...
public class InitUtils {
	...
	/**
	 * Add a difference to the name naming. This method simply initializes the namespace
	 * for Naming. Config initialization is not the same, so it cannot be reused directly.
	 * @param properties
	 * @return
	 */
	...
	public static String initEndpoint(final Properties properties) {
		...
		String endpointPort = TemplateUtils.stringEmptyAndThenExecute(
				System.getenv(PropertyKeyConst.SystemEnv.ALIBABA_ALIWARE_ENDPOINT_PORT), new Callable<String>() {
					@Override
					public String call() {
