...
/**
 * Uniform constant parameter naming for address servers and default values ​​for related
 * parameters
 *
 * @author pbting
...
public interface AddressServerConstants {
	...
	/**
	 * when the config and naming will separate deploy,then must specify product name by
	 * the client。
	 */
	 ...
	 */
	String ADDRESS_SERVER_REQUEST_URL = UtilsAndCommons.NACOS_SERVER_CONTEXT + UtilsAndCommons.NACOS_SERVER_VERSION
			+ "/as";
