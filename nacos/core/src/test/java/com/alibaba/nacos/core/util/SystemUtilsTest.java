...
public class SystemUtilsTest {
	...
	public void testReadClusterConf() throws IOException {
		...
		/*
		 * #it is ip #example 192.168.1.1:8848
		 */
		...
		/*
		 * #it is ip #example # 192.168.1.1:8848 192.168.1.2:8848 # Instance A
		 */
		SystemUtils.writeClusterConf("#it is ip" + lineSeparator + "  #example" + lineSeparator + "  # 192.168.1.1:8848"
				+ lineSeparator + "  192.168.1.2:8848 # Instance A  " + lineSeparator + "192.168.1.3#:8848");
