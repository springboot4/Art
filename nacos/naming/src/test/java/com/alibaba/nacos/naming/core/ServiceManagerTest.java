...
public class ServiceManagerTest extends BaseTest {
	...
	public void testUpdateIpAddresses() throws Exception {
		...
		List<Instance> instanceList = serviceManager.updateIpAddresses(service,
				UtilsAndCommons.UPDATE_INSTANCE_ACTION_ADD, true, instance);
		...
		instanceList = serviceManager.updateIpAddresses(service, UtilsAndCommons.UPDATE_INSTANCE_ACTION_REMOVE, true,
				instance);
		Assert.assertEquals(1, instanceList.size());
