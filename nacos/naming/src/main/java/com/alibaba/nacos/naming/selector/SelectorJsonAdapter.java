 ...
 * <p>
 * When deserializing object for class Selector, we should consider to convert the
 * selector to its runtime child class object. And this adapter helps us to finish it.
 *
 * @author nkorange
 * @since 0.7.0
 */
