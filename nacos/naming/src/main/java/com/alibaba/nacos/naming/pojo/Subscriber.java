...
public class Subscriber implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(addrStr, that.addrStr) && Objects.equals(agent, that.agent)
				&& Objects.equals(app, that.app) && Objects.equals(ip, that.ip)
				&& Objects.equals(namespaceId, that.namespaceId) && Objects.equals(serviceName, that.serviceName);
	}
