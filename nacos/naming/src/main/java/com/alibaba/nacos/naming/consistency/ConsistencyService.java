 ...
 * <p>
 * We announce this consistency service to decouple the specific consistency
 * implementation with business logic. User should not be aware of what consistency
 * protocol is being used.
 * <p>
 * In this way, we also provide space for user to extend the underlying consistency
 * protocols, as long as they obey our consistency baseline.
 *
 * @author nkorange
 * @since 1.0.0
 */
