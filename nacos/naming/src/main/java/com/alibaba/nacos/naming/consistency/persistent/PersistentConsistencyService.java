 ...
 * <p>
 * Once the writing operation returned client a success, the data within the operation is
 * guaranteed to be successfully written to the cluster. And the data should be consistent
 * between servers after some time without any outside interfere.
 *
 * @author nkorange
 * @since 1.0.0
 */
