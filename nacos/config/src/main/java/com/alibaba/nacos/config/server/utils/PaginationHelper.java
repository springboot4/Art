...
public class PaginationHelper<E> {
	...
	public Page<E> fetchPageLimit(final JdbcTemplate jt, final String sqlCountRows, final Object[] args1,
			final String sqlFetchRows, final Object[] args2, final int pageNo, final int pageSize,
			final RowMapper<E> rowMapper) {
		if (pageNo <= 0 || pageSize <= 0) {
			throw new IllegalArgumentException("pageNo and pageSize must be greater than zero");
		}
	...
	public Page<E> fetchPageLimit(final JdbcTemplate jt, final String sqlFetchRows, final Object[] args,
