...
//
// private static final String DB_LOAD_ERROR_MSG = "[db-load-error]load jdbc.properties
/// error";
//
...
// }
//
// TimerTaskService.scheduleWithFixedDelay(new
/// BasicDataSourceServiceImpl.SelectMasterTask(), 10, 10,
// TimeUnit.SECONDS);
// TimerTaskService.scheduleWithFixedDelay(new
/// BasicDataSourceServiceImpl.CheckDBHealthTask(), 10, 10,
// TimeUnit.SECONDS);
// }
// }
//
