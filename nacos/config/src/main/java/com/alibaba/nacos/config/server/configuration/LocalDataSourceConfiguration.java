...
//
// import static
/// com.alibaba.nacos.config.server.configuration.DataBaseConfiguration.DATA_SOURCE_BEAN_NAME;
//
/// **
...
//
// private static final String DEFAULT_APP_NAME = System.getProperty("user.home") +
/// File.separator + "nacos";
//
// private static final String APP_HOME = System.getProperty(NACOS_HOME_PROPERTY_NAME,
/// DEFAULT_APP_NAME);
//
// private static final String DATA_SOURCE_URL = "jdbc:derby:" + APP_HOME + File.separator
/// + DERBY_BASE_DIR +
// ";create=true";
//
