...
public class MemoryMonitor {
	...
	public MemoryMonitor(AsyncNotifyService notifySingleService) {
		...
		TimerTaskService.scheduleWithFixedDelay(new PrintMemoryTask(), DELAY_SECONDS, DELAY_SECONDS, TimeUnit.SECONDS);

		TimerTaskService.scheduleWithFixedDelay(new PrintGetConfigResponeTask(), DELAY_SECONDS, DELAY_SECONDS,
				TimeUnit.SECONDS);
