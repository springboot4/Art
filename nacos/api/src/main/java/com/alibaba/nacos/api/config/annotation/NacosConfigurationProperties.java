...
public @interface NacosConfigurationProperties {
	...
	/**
	 * set config type is yaml this method is deprecated, we support you use
	 * {@link #type()} to set config type
	...
	/**
	 * It indicates the properties of current doBind bean is auto-refreshed when Nacos
