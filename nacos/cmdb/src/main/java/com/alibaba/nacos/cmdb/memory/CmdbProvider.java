...
public class CmdbProvider implements CmdbReader, CmdbWriter {
	...
	public void load() {
		...
		if (labelNames == null || labelNames.isEmpty()) {
			...
			for (String labelName : labelNames) {
				// If get null label, it's still ok. We will try it later when we meet
				// this label:
	...
	public void init() throws NacosException {
		...
		UtilsAndCommons.GLOBAL_EXECUTOR.schedule(new CmdbLabelTask(), switches.getLabelTaskInterval(),
				TimeUnit.SECONDS);
		UtilsAndCommons.GLOBAL_EXECUTOR.schedule(new CmdbEventTask(), switches.getEventTaskInterval(),
				TimeUnit.SECONDS);
	}
		...
		public void run() {
			...
			try {
				...
				if (labelNames == null || labelNames.isEmpty()) {
					...
					for (String labelName : labelNames) {
						// If get null label, it's still ok. We will try it later when we
						// meet this label:
